                ...
                <div className="terms-body">
                    <h1>Wick Editor Open Source Applications Terms and Conditions</h1>
                        ...
                        <h2>Open Source Licenses and Notices</h2>
                            ...
                            <p>To the extent the terms of the licenses applicable to open source components require Wicklets to make an offer to provide source code in connection with the Software, such offer is hereby made, and you may exercise it by contacting Wicklets using this email: contact@wickeditor.com.</p>
                        ...
                        <h2>Privacy</h2>
                            <p>The Software may collect personal information. If the Software does collect personal information on Wicklets’s behalf, Wicklets will process that information in accordance with the <a href="www.wickeditor.com/#/privacy-policy">Wicklets Privacy Policy</a>.</p>
