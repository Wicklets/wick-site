                ...
                <div className="terms-body">
                    <h1>Wick Editor Open Source Applications Terms and Conditions</h1>
                        ...
                        <h2>Wicklets's Logos</h2>
                            ...
                            <p>The names Wicklets, Wick Editor, WickEditor, and related Wicklets logos and Wick Editor logos and/or stylized names are trademarks of Wicklets. You agree not to display or use these trademarks in any manner without Wicklets’s prior, written permission, except as allowed by Wicklets’s Logos and Usage Policy: <a href="https://www.wickeditor.com/#/logos">https://www.wickeditor.com/#/logos</a>.</p>
                        <h2>Privacy</h2>
                            <p>The Software may collect personal information. If the Software does collect personal information on Wicklets’s behalf, Wicklets will process that information in accordance with the <a href="https://www.wickeditor.com/#/privacy-policy">Wicklets Privacy Policy</a>. By using this software, you agree to the terms of the <a href="https://www.wickeditor.com/#/privacy-policy">Wicklets Privacy Policy</a>. A copy of the Wicklets Privacy Policy can be found at https://www.wickeditor.com/#/privacy-policy.</p>
                        <h2>Cookies</h2>
                            <p>The software uses cookies to improve your user experience, and improve our website. These cookies will be used in accordance with the <a href="https://https://www.wickeditor.com/#/cookie-policy">Wicklets Cookie Policy</a>. By using this software, you agree to the terms of the <a href="https://www.wickeditor.com/#/cookie-policy">Wicklets Cookie Policy</a>. A copy of the Wicklets Cookie Policy can be found at https://www.wickeditor.com/#/cookie-policy.</p>    
                        ...
                        <h2>Disclaimers and Limitations of Liability</h2>
                            <p>THE SOFTWARE IS PROVIDED ON AN "AS IS" BASIS, AND NO WARRANTY, EITHER EXPRESS OR IMPLIED, IS GIVEN. YOUR USE OF THE SOFTWARE IS AT YOUR SOLE RISK. Wicklets does not warrant that (i) the Software will meet your specific requirements; (ii) the Software is fully compatible with any particular platform; (iii) your use of the Software will be uninterrupted, timely, secure, or error-free; (iv) the results that may be obtained from the use of the Software will be accurate or reliable; (v) the quality of any products, services, information, or other material purchased or obtained by you through the Software will meet your expectations; or (vi) any errors in the Software will be corrected. YOU EXPRESSLY UNDERSTAND AND AGREE THAT WICKLETS SHALL NOT BE LIABLE FOR ANY DIRECT, INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL OR EXEMPLARY DAMAGES, INCLUDING BUT NOT LIMITED TO, DAMAGES FOR LOSS OF PROFITS, GOODWILL, USE, DATA OR OTHER INTANGIBLE LOSSES (EVEN IF WICKLETS HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES) RELATED TO THE SOFTWARE, including, for example: (i) the use or the inability to use the Software; (ii) the cost of procurement of substitute goods and Software resulting from any goods, data, information or Software purchased or obtained or messages received or transactions entered into through or from the Software; (iii) unauthorized access to or alteration of your transmissions or data; (iv) statements or conduct of any third-party on the Software; (v) or any other matter relating to the Software. Wicklets reserves the right at any time and from time to time to modify or discontinue, temporarily or permanently, the Software (or any part thereof) with or without notice. Wicklets shall not be liable to you or to any third-party for any price change, suspension or discontinuance of the Software.</p>
                        <h2>Miscellanea</h2>
                            <ol>
